...
#import "Game.h"
#import "Options.h"
#import "NuanceWebController.h"//jackson
...
@interface GameController : NSObject <UIActionSheetDelegate> {
   ...
   NuanceWebController *nuController;//jackson
}
...
@property (nonatomic, readonly, retain) NuanceWebController *nuController;//jackson
@property NSMutableArray *leftOverSpeech;
...
- (void)onVoiceCaptureResult:(NSNotification *)aNotification;
